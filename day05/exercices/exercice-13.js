...
function formater(montant) {
    // Converts input to a number and formats it using spaces as thousands separators
    const formatted = new Intl.NumberFormat('fr-FR').format(Number(montant));
    return `${formatted} MAD`;
}

console.log(formater(1234567)); // "1 234 567 MAD"